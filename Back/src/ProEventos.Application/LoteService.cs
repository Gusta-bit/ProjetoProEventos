...
namespace ProEventos.Application
{
    public class LoteService : ILoteService
    {
        ...
        private readonly ILotePersistence _lotePersit;
        private readonly IMapper _mapper;
        public LoteService(IGeralPersistence geralPersit,
                           ILotePersistence lotePersit,
                           IMapper mapper)
        {
        ...
        public async Task<bool> DeleteLote(int eventoId, int loteId)
        {
            try
            {
                ...
                if (lote == null) throw new Exception("Lote para excluir não encontrado.");
